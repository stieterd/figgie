...
class TradingBot:
    ...
    def on_trade_event(round_data: dict, round_history: dict) -> dict:
        ...
        print(round_data)
        # print(round_history)
        return {'Diamonds': {'Sell': 4}, 'Hearts': {'Buy': 4, 'Sell': 8}, 'Spades': [], 'Clubs': []}
...
class FiggieGame:
    ...
    @staticmethod
    def cancel_order(wsapp, direction: str, suit: str, price: int):  # direction: Buy or Sell, suit: Diamonds, Clubs, Spades, Hearts
            ...
            for key, value in orders.items():
                ...
                for direction, price in value.items():
                    ...
                    for market in round_data['markets']:
                        ...
                        if direction == "Sell" and market[1][way]['user'][price] <= price:
                            veto = True
                        elif direction == "Buy" and market[1][way]['user'][price] >= price:
                            veto = True
